...
//import ahalya from '../images/rubipreethi.jpg';
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:rubypreethi@example.com" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
              ...
              <span>rubypreethi@example.com</span>
            </a>
            <a href="tel:+1234567890" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
              <Phone className="w-6 h-6" />
              <span>+1 234 567 890</span>
            </a>
            <a href="https://linkedin.com/in/rubypreethi" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
